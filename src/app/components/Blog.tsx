...
const Blog = () => {
  return (
    <section className='py-20 container max-w-7xl mx-auto px-4'>
      <h2 className='text-3xl font-bold mb-12 text-center'>Derniers Articles de Blog</h2>
      ...
      <div className='text-center mt-12'>
        <Link href="/blogs" className='inline-block bg-primary text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors'>Voir tous les articles</Link>
      </div>
