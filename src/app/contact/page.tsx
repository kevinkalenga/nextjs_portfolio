        ...
        >
          <motion.div {...fadeInUp}>
            ...
            <p className="text-secondary">
              Passionné par le développement web, je suis toujours ouvert à discuter de nouveaux projets, 
              d’idées créatives et d’opportunités de collaboration.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <a href="mailto:kevinkalenga10@gmail.com" className="text-secondary hover:text-primary">
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary">155 Route de fleury, 91170 Viry-Chatillon</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
